        ...
        <div class="d-flex align-items-center gap-lg-2 gap-1">
            ...
            <div class="logo-topbar">
                ...
                <a href="{{ route('admin.home') }}" class="logo-light">
                    <span class="logo-lg">
                        <img src="{{asset('assets/images/dexology.png')}}" alt="logo">
                    </span>
                    <span class="logo-sm">
                        <img src="{{asset('assets/images/dexology.png')}}" alt="small logo">
                    </span>
                </a>
                ...
                <a href="index.html" class="logo-dark">
                    <span class="logo-lg">
                        <img src="{{asset('assets/images/dexology.png')}}" alt="dark logo">
                    </span>
                    <span class="logo-sm">
                        <img src="{{asset('assets/images/dexology.png')}}" alt="small logo">
                    </span>
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="d-lg-flex flex-column gap-1 d-none">
                        <h5 class="my-0">{{$AUTH_USER->name}}</h5>
