            ...
            <div class="box-content">
                <div class="clearfix bg-lighter">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h3 class="mb-0 text-uppercase">portfolio List</h3>
                        <a href="{{ route('admin.portfolios.create') }}" class="btn btn-primary"> <i
                    ...
                    <tbody>
                        @forelse ($portfolios as $key=>$portfolio)
                            <tr id="row_{{ $key }}">
                                ...
                                <td><span class="badge bg-{{ $portfolio->status == 1 ? 'success' : 'danger' }}">
                                        {{ $portfolio->status == 1 ? 'Active' : 'Inactive' }}
                                    </span></td>
                                <td><img src="{{ Str::storage_path($portfolio->feature_image) }}" style="height: 100px">
                                </td>
                                ...
                                <td>
                                    ...
                                    <button type="button"
                                        onclick="confirmDelete('{{ route('admin.portfolios.destroy', $portfolio->id) }}', {{ $key }},'{{ csrf_token() }}')"
