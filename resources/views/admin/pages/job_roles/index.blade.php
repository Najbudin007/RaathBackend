            ...
            <div class="box-content">
                <div class="clearfix bg-lighter">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h3 class="mb-0 text-uppercase">jobrole List</h3>
                        <a href="{{ route('admin.job_roles.create') }}" class="btn btn-primary"> <i
                    ...
                    <tbody>
                        @forelse ($jobroles as $key=>$jobrole)
                            <tr id="row_{{ $key }}">
                                ...
                                <td>
                                    <a href="{{ route('admin.job_roles.edit', $jobrole->id) }}"
                                        class="btn btn-primary btn-sm">Edit</a>
                                    <button type="button"
                                        onclick="confirmDelete('{{ route('admin.job_roles.destroy', $jobrole->id) }}', {{ $key }},'{{ csrf_token() }}')"
