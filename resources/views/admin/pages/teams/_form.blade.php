        ...
        <form method="POST" action="{{ $action }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select id="type" name="type" class="form-select @error('type') is-invalid @enderror" required>
                    ...
                    <option value="gbc" {{ (isset($team) && $team->type == 'gbc') || old('type') == 'gbc' ? 'selected' : '' }}>GBC</option>
                    <option value="executive" {{ (isset($team) && $team->type == 'executive') || old('type') == 'executive' ? 'selected' : '' }}>Executive</option>
                </select>
                @error('type')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
            ...
            {{-- for achievements mutiples --}}

            <div class="mb-3">
                <label for="achievements" class="required">Achievements</label>
                <input id="achievements" type="text" class="form-control @error('achievements') is-invalid @enderror"
                    name="achievements[]" required value="{{ old('achievements.0', $team->achievements[0] ?? '') }}">
            ...
            <div class="mb-3">
                <label for="description" class="required">Bio</label>
